...
function boardTexShader(gl: WebGLRenderingContext) {
  ...
  `;
    ...
    void main() {
      ...
      gl_FragColor = color;
      gl_FragColor += texture2D(texture1, texCoordV) * (colorB * alphaA + colorC * (1.0-alphaA));
